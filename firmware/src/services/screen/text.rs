...
pub fn center(frame: &mut Frame, baseline: i32, content: impl Content) {
    render(
        frame,
...
pub fn left(frame: &mut Frame, baseline: i32, content: impl Content) {
    render(
        frame,
...
pub fn right(frame: &mut Frame, baseline: i32, content: impl Content) {
    render(
        frame,
...
fn render(frame: &mut Frame, point: Point, alignment: HorizontalAlignment, content: impl Content) {
